...
$\left\{ 4.38,4.37,4.33,4.34,4.31,4.39\right\}$ .Suposant que $pH|T\sim N\left(\mu_{T},\sigma^{2}\right)$ amb $\mu_{T}$ i $\sigma$ desconeguts. Amb $\alpha=0.05$, plantejant i contestant els tests adequats, contesteu les preguntes següents:

8.a) Les dues esperances són iguals? o no? (hem suposat variàncies iguals)
