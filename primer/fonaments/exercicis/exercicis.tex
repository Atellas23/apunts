...
\begin{legal}[start=21]
	...
	\end{legal}
	\item[30.] \textbf{Considerem una aplicació $f: \ A\mapsto B$ i subconjunts $A',A''\subseteq A$ i $B',B''\subseteq B$. Demostreu:}
	\begin{legal}
		\item[30.1.] \textbf{Si $A'\subseteq A''$, aleshores $f(A')\subseteq f(A'')$. Demostreu que la igualtat és certa si $f$ és injectiva.}
		...
		\item[30.2.] \textbf{Si $B'\subseteq B''$, aleshores $f^{-1}(B')\subseteq f^{-1}(B'')$. Demostreu que la igualtat és certa si $f$ és exhaustiva.}
...
%		La igualtat d'antiimatges es donarà quan $B'=B''$.
	...
	\begin{legal}
		...
		$$f(A')=f(f^{-1}(f(A')))=Id_B(f(A'))=f(A')$$i $A'=A'$, per tant, queda demostrat l'enunciat.
	\end{legal}
\end{legal}
